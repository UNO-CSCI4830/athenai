              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-8">
                {modules.length > 0 ? (
                  modules.map((module, index) => (
                    <div
                      key={index}
                      className="backdrop-blur-md bg-white/10 border border-white/10 p-4 rounded-md flex items-center justify-between"
                    >
                      <div>
                        ...
                        <p className="text-sm text-gray-200">
                          Type: {module.type}, Catergory: {module.category}
                        </p>
                      </div>
                      <div className="flex gap-4">
                        <a
                ...
                featuredInternships.map((internship, index) => (
                  ...
                  >
                    ...
                    <div className="flex gap-4">
                      <a
                        href="/postings"
                        className="px-40 py-5 ml-4 bg-white text-gray-800 rounded-sm hover:bg-gray-800 hover:text-white transition"
                      >
                        Apply Now
                      </a>
                    </div>
