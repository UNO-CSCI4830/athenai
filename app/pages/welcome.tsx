      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white font-sans flex">
        ...
        <aside className="w-64 p-6 backdrop-blur-md bg-white/5 border-r border-white/10">
          ...
          <ul className="space-y-4 text-sm">
            <SidebarLink to="/home" icon="🏠" label="Home" />
            <SidebarLink to="/profile" icon="📖" label="Profile" />
            <SidebarLink to="/module" icon="📚" label="Modules" />
            <SidebarLink to="/networking" icon="🤝" label="Networking" />
            ...
            <div className="backdrop-blur-md bg-white/10 border border-white/10 p-6 rounded-lg">
              ...
              <ul className="space-y-4">
                {resources.map(({ href, text, icon }) => (
                  <li key={href}>
                    <a
                      className="group flex items-center gap-3 p-3 text-blue-700 hover:underline dark:text-blue-500"
                      href={href}
                      target="_blank"
                      rel="noreferrer"
                    >
